...
// TBD: Move to utility package, eg isl.util, or perhaps isl.table
package bsg.util;
...
public class StringUtils
{
  ...
  /**
   * TBD: Move method to String Utilities class
   */
  ...
  public static String convertStreamToString(java.io.InputStream is) throws NullPointerException {
    if (is == null) throw new NullPointerException("InputStream cannot be null");
